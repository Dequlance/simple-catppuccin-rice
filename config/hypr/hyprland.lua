...
local terminal = "kitty --conf /home/user/.config/kitty/config.conf"

local fileManager = "nemo"

local menu = "wofi --conf /home/user/.config/wofi/config.conf"
...
hl.config({
    general = {
        ...
        layout = "dwindle",
        col = {
            active_border = { colors = { "rgb(181825)", "rgb(cba6f7)" }, angle = 45 },
...
hl.bind(mainMod .. " + " .. "Q", hl.dsp.exec_cmd("kitty --conf /home/user/.config/kitty/config.conf"))
...
hl.bind(mainMod .. " + " .. "R", hl.dsp.exec_cmd("wofi --conf /home/user/.config/wofi/config.conf"))
...
hl.bind(mainMod .. " + " .. "PRINT", hl.dsp.exec_cmd("HYPRSHOT_DIR=/home/user/screenshots hyprshot -m window"))

-- Screenshot a monitor

hl.bind("PRINT", hl.dsp.exec_cmd("HYPRSHOT_DIR=/home/user/screenshots hyprshot -m output"))

-- Screenshot a region

hl.bind(shiftMod .. " + " .. "PRINT", hl.dsp.exec_cmd("HYPRSHOT_DIR=/home/user/screenshots hyprshot -m region"))
...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("[workspace 2 silent] steam")
